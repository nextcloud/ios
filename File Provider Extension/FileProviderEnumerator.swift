                        ...
                        OCNetworking.sharedManager().readFolder(withAccount: self.providerData.account, serverUrl: serverUrl, depth: "1", completion: { (account, metadatas, metadataFolder, message, errorCode) in
                            ...
                            if errorCode == 0 && account == self.providerData.account {
                                ...
                                if metadataFolder != nil {
                                    ...
                                    NCManageDatabase.sharedInstance.setDirectory(serverUrl: serverUrl, serverUrlTo: nil, etag: metadataFolder!.etag, fileID: metadataFolder!.fileID, id: metadataFolder!.id, encrypted: metadataFolder!.e2eEncrypted, account: self.providerData.account)
