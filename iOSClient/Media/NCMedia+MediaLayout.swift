...
extension NCMedia: NCMediaLayoutDelegate {
    func getColumnCount() -> Int {
        let layoutForView = NCManageDatabase.shared.getLayoutForView(account: NCDomain.shared.getActiveDomain().account, key: NCGlobal.shared.layoutViewMedia, serverUrl: "")
