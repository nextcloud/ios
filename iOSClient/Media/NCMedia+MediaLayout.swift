...
extension NCMedia: NCMediaLayoutDelegate {
    func getColumnCount() -> Int {
        let layoutForView = NCManageDatabase.shared.getLayoutForView(account: NCSession.shared.getSession(controller: tabBarController).account, key: NCGlobal.shared.layoutViewMedia, serverUrl: "")
