...
@objc class NCViewerRichWorkspace: UIViewController, UIAdaptivePresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let editItem = UIBarButtonItem(image: NCUtility().loadImage(imageName: "square.and.pencil"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(editItemAction(_:)))
