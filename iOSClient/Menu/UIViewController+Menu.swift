...
extension UIViewController {
    ...
    func presentMenu(with actions: [NCMenuAction], menuColor: UIColor = NCBrandColor.shared.fileMenuBackgroundColor, textColor: UIColor = NCBrandColor.shared.textColor) {
