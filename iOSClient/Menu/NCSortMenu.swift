...
class NCSortMenu: NSObject {
    ...
    func toggleMenu(viewController: UIViewController, account: String, key: String, sortButton: UIButton?, serverUrl: String, hideDirectoryOnTop: Bool = false) {
        ...
        if layoutForView.ascending {
            ...
            icon = UIImage(named: "sortFileNameZA")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        } else {
            title = NSLocalizedString("_order_by_name_a_z_", comment: "")
            icon = UIImage(named: "sortFileNameAZ")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        }
        ...
        if layoutForView.ascending {
            ...
            icon = UIImage(named: "sortDateMoreRecent")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        } else {
            title = NSLocalizedString("_order_by_date_less_recent_", comment: "")
            icon = UIImage(named: "sortDateLessRecent")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        }
        ...
        if layoutForView.ascending {
            ...
            icon = UIImage(named: "sortLargest")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        } else {
            title = NSLocalizedString("_order_by_size_smallest_", comment: "")
            icon = UIImage(named: "sortSmallest")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50)
        }
        ...
        if !hideDirectoryOnTop {
            actions.append(
                NCMenuAction(
                    ...
                    icon: UIImage(named: "foldersOnTop")!.image(color: NCBrandColor.shared.iconImageColor2, size: 50),
