...
@objc class NCNetworking: NSObject, NCCommunicationCommonDelegate {
    ...
    func writeCertificate(host: String) {
        ...
        if !NCUtilityFileSystem.shared.moveFile(atPath: certificateAtPath, toPath: certificateToPath) {
            NCContentPresenter.shared.messageNotification("_error_", description: "_error_creation_file_", delay: NCGlobal.shared.dismissAfterSecond, type: NCContentPresenter.messageType.error, errorCode: NCGlobal.shared.errorCreationFile)
        }
    }
