...
- (void)applicationInitialized
{
    ...
    NSString *autoUploadServerUrl = [[NCManageDatabase sharedInstance] getAccountAutoUploadPath:_activeUrl];
    if ([autoUploadServerUrl length] > 0)
        [[CCSynchronize sharedSynchronize] readFolderServerUrl:autoUploadServerUrl directoryID:[[NCManageDatabase sharedInstance] getDirectoryID:autoUploadServerUrl] selector:selectorReadFolder];
