...
final class NCGlobal: Sendable {
    ...
    //
    let taskIdentifierActivity              = "_IdActivity"
    let taskIdentifierCapabilities          = "_IdCapabilities"
    let taskIdentifierCheckServer           = "_IdCheckServer"
    let taskIdentifierClearStatusMessage    = "_IdClearStatusMessage"
    let taskIdentifierComments              = "_IdComments"
    let taskIdentifierCopyFileOrFolder      = "_IdCopyFileOrFolder"
    let taskIdentifierCreateFolder          = "_IdCreateFolder"
    let taskIdentifierCreateRichdocuments   = "_IdCreateRichdocuments"
    let taskIdentifierCustomMessageUser     = "_IdCustomMessageUser"
    let taskIdentifierDashboardWidget       = "_IdDashboardWidget"
    let taskIdentifierDeleteFileOrFolder    = "_IdDeleteFileOrFolder"
    let taskIdentifierDiagnosticsRemote     = "_IdDiagnosticsRemote"
    let taskIdentifierDirectDownload        = "_IdDirectDownload"
    let taskIdentifierDownload              = "_IdDownload"
    let taskIdentifierDownloadAvatar        = "_IdDownloadAvatar"
    let taskIdentifierDownloadContent       = "_IdTextDownloadContent"
    let taskIdentifierDownloadPreview       = "_IdDownloadPreview"
    let taskIdentifierE2EECertificate       = "_IdE2EECertificate"
    let taskIdentifierE2EEFavorite          = "_IdE2EEFavorite"
    let taskIdentifierE2EEKey               = "_IdE2EEKey"
    let taskIdentifierE2EELock              = "_IdE2EELock"
    let taskIdentifierE2EEMarkFolder        = "_IdE2EEMarkFolder"
    let taskIdentifierE2EEMetadata          = "_IdE2EEMetadata"
    let taskIdentifierExternalSite          = "_IdExternalSite"
    let taskIdentifierGroupfolders          = "_IdGroupfolders"
    let taskIdentifierHovercard             = "_IdHovercard"
    let taskIdentifierListingFavorites      = "_IdListingFavorites"
    let taskIdentifierListingTrash          = "_IdListingTrash"
    let taskIdentifierListOfTemplates       = "_IdListOfTemplates"
    let taskIdentifierLivePhoto             = "_IdLivePhoto"
    let taskIdentifierLockUnlockFile        = "_IdLockUnlockFile"
    ...
    let taskIdentifierRecommendedFiles      = "_IdRecommendedFiles"
    let taskIdentifierRemoteWipeStatus      = "_IdRemoteWipeStatus"
    let taskIdentifierSearch                = "_IdSearch"
    let taskIdentifierSearchProvider        = "_IdSearchProvider"
    let taskIdentifierServerStatus          = "_IdServerStatus"
    let taskIdentifierShare                 = "_IdShare"
    let taskIdentifierSyncMetadata          = "_IdSyncMetadata"
    let taskIdentifierTemplatesRichdocuments = "_IdTemplatesRichdocuments"
    let taskIdentifierTermsOfService        = "_IdTermsOfService"
    let taskIdentifierTextCreateFile        = "_IdTextCreateFile"
    let taskIdentifierTextEditorDetails     = "_IdTextEditorDetails"
    let taskIdentifierTextOpenFile          = "_IdTextOpenFile"
    let taskIdentifierUnifiedSearch         = "_IdUnifiedSearch"
    let taskIdentifierUpload                = "_IdUpload"
    let taskIdentifierUserMetadata          = "_IdUserMetadata"
    let taskIdentifierUserProfile           = "_IdUserProfile"
    let taskIdentifierUserStatus            = "_IdUserStatus"
