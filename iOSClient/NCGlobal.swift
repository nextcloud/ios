...
final class NCGlobal: Sendable {
    ...
    //
    let taskIdentifierActivity              = "IdActivity"
    let taskIdentifierCapabilities          = "IdCapabilities"
    let taskIdentifierCheckServer           = "IdCheckServer"
    let taskIdentifierClearStatusMessage    = "IdClearStatusMessage"
    let taskIdentifierComments              = "IdComments"
    let taskIdentifierCopyFileOrFolder      = "IdCopyFileOrFolder"
    let taskIdentifierCreateFolder          = "IdCreateFolder"
    let taskIdentifierCreateRichdocuments   = "IdCreateRichdocuments"
    let taskIdentifierCustomMessageUser     = "IdCustomMessageUser"
    ...
    let taskIdentifierDirectDownload        = "IdDirectDownload"
    let taskIdentifierDownload              = "IdDownload"
    let taskIdentifierDownloadAvatar        = "IdDownloadAvatar"
    let taskIdentifierDownloadContent       = "IdTextDownloadContent"
    ...
    let taskIdentifierE2EELock              = "IdE2EELock"
    let taskIdentifierE2EEMarkFolder        = "IdE2EEMarkFolder"
    let taskIdentifierE2EEMetadata          = "IdE2EEMetadata"
    ...
    let taskIdentifierSearchProvider        = "IdSearchProvider"
    let taskIdentifierServerStatus          = "IdServerStatus"
    let taskIdentifierShare                 = "IdShare"
    ...
    let taskIdentifierUnifiedSearch         = "IdUnifiedSearch"
    let taskIdentifierUpload                = "IdUpload"
