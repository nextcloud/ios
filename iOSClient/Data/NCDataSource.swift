...
class NCDataSource: NSObject {
    ...
    init(metadatasSource: [tableMetadata], account: String, etag: String? = nil, sort: String? = "none", ascending: Bool? = false, directoryOnTop: Bool? = true, favoriteOnTop: Bool? = true, filterLivePhoto: Bool? = true, groupByField: String = "name", providers: [NCCSearchProvider]? = nil, searchResults: [NCCSearchResult]? = nil) {
        super.init()
