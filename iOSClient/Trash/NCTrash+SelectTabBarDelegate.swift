...
extension NCTrash: NCTrashSelectTabBarDelegate {
    func onListSelected() {
        if layoutForView?.layout == NCGlobal.shared.layoutGrid {
            ...
            NCManageDatabase.shared.setLayoutForView(account: NCSession.shared.getSession(controller: tabBarController).account, key: layoutKey, serverUrl: "", layout: layoutForView?.layout)
