...
class NCShares: NCCollectionViewCommon {
    ...
    override func queryDB() {
        ...
        func reload() {
            self.dataSource = NCDataSource(metadatas: metadatas, account: domain.account, layoutForView: layoutForView, providers: providers, searchResults: searchResults)
    ...
    override func reloadDataSourceNetwork(withQueryDB: Bool = false) {
        ...
        NextcloudKit.shared.readShares(parameters: NKShareParameter(), account:NCDomain.shared.getActiveAccount()) { task in
            self.dataSourceTask = task
            self.collectionView.reloadData()
