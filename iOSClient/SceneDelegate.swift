            ...
            if let urlComponents = URLComponents(url: url, resolvingAgainstBaseURL: false) {
                ...
                case NCGlobal.shared.actionTextDocument:
                    ...
                    Task {
                        ...
                        self.appDelegate?.createDocument(controller: controller, fileNamePath: fileNamePath, fileName: String(describing: fileName), editorId: NCGlobal.shared.editorText, creatorId: directEditingCreator.identifier, templateId: NCGlobal.shared.templateDocument)
                    }
