...
extension NCCollectionViewCommon: NCMediaLayoutDelegate {
    ...
    func getLayout() -> String? {
        return NCManageDatabase.shared.getLayoutForView(account: NCSession.shared.getSession(controller: self.tabBarController).account, key: NCGlobal.shared.layoutViewFiles, serverUrl: serverUrl)?.layout
    }
