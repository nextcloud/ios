...
extension NCCollectionViewCommon: NCMediaLayoutDelegate {
    ...
    func getLayout() -> String? {
        return NCManageDatabase.shared.getLayoutForView(account: NCDomain.shared.getActiveAccount(), key: NCGlobal.shared.layoutViewFiles, serverUrl: serverUrl)?.layout
    }
