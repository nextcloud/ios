...
public let collectionViewPhotoElementKindSectionHeader = "collectionViewPhotoElementKindSectionHeader"
public let collectionViewPhotoElementKindSectionFooter = "collectionViewPhotoElementKindSectionFooter"

protocol NCPhotoLayoutDelegate: UICollectionViewDelegate {
...
public class NCPhotoLayout: UICollectionViewLayout {
    ...
    private weak var delegate: NCPhotoLayoutDelegate? {
        return collectionView?.delegate as? NCPhotoLayoutDelegate
    }
    ...
    public override func prepare() {
        ...
        for section in 0..<numberOfSections {
            ...
            */
            ...
            if headerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: collectionViewPhotoElementKindSectionHeader, with: NSIndexPath(item: 0, section: section) as IndexPath)
            ...
            */
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: collectionViewPhotoElementKindSectionFooter, with: NSIndexPath(item: 0, section: section) as IndexPath)
    ...
    public override func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        if elementKind == collectionViewPhotoElementKindSectionHeader {
            attribute = headersAttribute[indexPath.section]
        } else if elementKind == collectionViewPhotoElementKindSectionFooter {
...
private extension NCPhotoLayout {
