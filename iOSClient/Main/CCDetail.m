...
- (void)createToolbar
{
    ...
    if ([_fileNameExtension isEqualToString:@"TXT"]) {
        if ([CCUtility isFolderEncrypted:[[NCManageDatabase sharedInstance] getServerUrl:_metadataDetail.directoryID] account:appDelegate.activeAccount depth:NO]) // E2EE
