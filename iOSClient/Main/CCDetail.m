...
- (void)createToolbar
{
    ...
    if ([CCUtility isDocumentModifiableExtension:fileNameExtension] || [InfomaniakUtils isDocumentModifiableWithOnlyOfficeWithMimeType:self.metadataDetail.contentType]) {
