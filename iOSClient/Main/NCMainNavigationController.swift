...
class NCMainNavigationController: UINavigationController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        assistantButton.addAction(UIAction(handler: { _ in
            let assistant = NCAssistant(assistantModel: NCAssistantModel(controller: self.controller), chatModel: NCAssistantChatModel(controller: self.controller), sessionsModel: NCAssistantChatSessionsModel(controller: self.controller))
