...
class DocumentPickerViewController: UIDocumentPickerExtensionViewController, CCNetworkingDelegate, OCNetworkingDelegate, BKPasscodeViewControllerDelegate {
    ...
    func downloadFileFailure(_ fileID: String!, serverUrl: String!, selector: String!, message: String!, errorCode: Int) {
        ...
        // Activity
        CCCoreData.addActivityFile(fileID, action: "Download File Document Picker", note: "Selector : \(selector) Error : \(message)", type: k_activityTypeFailure, verbose: Int(k_activityVerboseDebug), account: self.activeAccount)
    ...
    func downloadFileSuccess(_ fileID: String!, serverUrl: String!, selector: String!, selectorPost: String!) {
        ...
        // Activity
        CCCoreData.addActivityFile(metadata!.fileName, action: "Download File Document Picker", note: "Selector : \(selector)", type: k_activityTypeSuccess, verbose: Int(k_activityVerboseDebug), account: metadata!.account)
    ...
    func uploadFileFailure(_ metadataNet: CCMetadataNet, fileID: String, serverUrl: String, selector: String, message: String, errorCode: NSInteger){
        ...
        // Activity
        CCCoreData.addActivityFile(metadataNet.fileName, action: "Upload File Document Picker", note: "Selector : \(selector) Error : \(message)", type: k_activityTypeFailure, verbose: Int(k_activityVerboseDebug), account: metadataNet.account)
    ...
    func uploadFileSuccess(_ metadataNet: CCMetadataNet, fileID: String, serverUrl: String, selector: String, selectorPost: String) {
        ...
        // Activity
        CCCoreData.addActivityFile(metadataNet.fileName, action: "Upload File Document Picker", note: "Selector : \(selector)", type: k_activityTypeSuccess, verbose: Int(k_activityVerboseDebug), account: metadataNet.account)
