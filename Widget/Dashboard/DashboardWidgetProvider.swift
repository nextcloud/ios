...
struct DashboardWidgetProvider: IntentTimelineProvider {
    ...
    func placeholder(in context: Context) -> Entry {
        ...
        return Entry(date: Date(), datas: datasPlaceholder, dashboard: nil, buttons: nil, isPlaceholder: true, isEmpty: false, titleImage: titleImage, title: title, footerImage: "Cloud_Checkmark", footerText: NCBrandOptions.shared.brand + " widget", account: "")
    }
