            ...
            ZStack(alignment: .topLeading) {
                ...
                HStack(spacing: 0) {
                    ...
                    Link(destination: entry.isPlaceholder ? linkNoAction : linkActionUploadAsset, label: {
                        Image("addImage")
                            .resizable()
                            .renderingMode(.template)
                            .foregroundColor(entry.isPlaceholder ? Color(.systemGray4) : Color(NCBrandColor.shared.getBrandText(account: entry.account)))
                            .padding(11)
                            .background(entry.isPlaceholder ? Color(.systemGray4) : Color(NCBrandColor.shared.getBrandElement(account: entry.account)))
                            .clipShape(Circle())
                            .scaledToFit()
                ...
                HStack {
                    Image(systemName: entry.footerImage)
                        ...
                        .font(Font.system(.body).weight(.light))
                        .foregroundColor(entry.isPlaceholder ? Color(.systemGray4) : Color(NCBrandColor.shared.getBrandElement(account: entry.account)))
